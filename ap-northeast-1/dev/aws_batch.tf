...
#   compute_environment_name = "${var.project_name}-${var.env}-push-notification-compute-environment"
#   compute_resources {
#     type    = "Fargate"
...
#   tags = {
#     Name      = "${var.project_name}-${var.env}-push-notification-compute-environment"
#     Env       = var.env
#     ManagedBy = "Terraform"
#   }
# }
...
#   name                 = "${var.project_name}-${var.env}-push-notification-batch-queue"
#   state                = "ENABLED"
#   priority             = 1
...
#   name                  = "${var.project_name}-${var.env}-push-notification-batch-job-def"
#   type                  = "container"
...
#   compute_environment_name = "${var.project_name}-${var.env}-public-compute-environment"
#   compute_resources {
#     type = "Fargate"
#     subnets = [
...
#   tags = {
#     Name      = "${var.project_name}-${var.env}-public-compute-environment"
#     Env       = var.env
#     ManagedBy = "Terraform"
#   }
# }
...
#   name                 = "${var.project_name}-${var.env}-public-batch-queue"
#   state                = "ENABLED"
#   priority             = 1
...
#   name                  = "${var.project_name}-${var.env}-public-batch-job-def"
#   type                  = "container"
#   platform_capabilities = ["FARGATE"]
