...
resource "aws_lambda_function" "main" {
  ...
  function_name = "${var.project_name}-${var.env}-api${count.index + 101}"
...
#   source_arn    = "arn:aws:execute-api:${var.region}:${data.aws_caller_identity.current.account_id}:${var.rest_api_id}/*/${aws_api_gateway_method.get[count.index].http_method}/api${count.index + 101}"
# }
